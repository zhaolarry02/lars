...
def function(dir, wlen, color, shutter):
    #closed
    timelistc = []
    ratelistc1 = []
    # ratelistc2 = []
    ...
    timelistc, ratelistc1 = zip(*sorted(zip(timelistc, ratelistc1)))
    timelisto, ratelisto1 = zip(*sorted(zip(timelisto, ratelisto1)))
    ...
    plt.scatter(time_newo, ratelisto1, c=color, label=dir+'Ch 1')
...
function("C:/Users/lzvio/Day1_RatevTime", 1280, 'b', '1280A3')
function("C:/Users/lzvio/Day2_RatevTime", 1280, 'g', '1280A3')
function("C:/Users/lzvio/Day3_RatevTime", 1280, 'r', '1280A2')
plt.xlim(0, 3500)
plt.ylim(0, 400)
plt.legend()
plt.show()